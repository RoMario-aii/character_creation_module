...
def attack(char_name: str, char_class: str) -> str:
    """Определяет величину урона в зависимости от класса персонажа."""
...
def defence(char_name: str, char_class: str) -> str:
    """Определяет величину блока в зависимости от класса персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Определяет специальное умение в зависимости от класса персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Тренировка управления навыками выбранного персонажа."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Определяет какой класс хочет выбрать игрок."""
    approve_choice: str = ''
    char_class: str = ''
